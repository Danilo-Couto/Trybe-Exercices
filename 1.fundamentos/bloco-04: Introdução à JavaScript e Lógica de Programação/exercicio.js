...
/* var pecadezadrez = 'PEAO'; 

switch (pecadezadrez.toLocaleLowerCase()) {
    case 'cavalo':
        console.log ('anda e come em l');
        break;
        case 'peao':
            console.log ('anda de um em um apenas para frente e come em diagonal');
            break;
                default: 
...
if (nota <0 || nota >100) {
    console.log ('Insira uma nota maior que zero e menor que 100');
} else {
...
let aliquota_inss = Number;
let desconto_inss = Number;
let salario_liquido_1 = Number;
let aliquota_ir = Number;
let desconto_ir = Number;
...
if (aliquota_inss === 570.88) {
    desconto_inss = aliquota_inss;
} else { 
    desconto_inss = (salario_bruto*aliquota_inss);
}
salario_liquido_1= (salario_bruto-desconto_inss);



if (salario_liquido_1 <= 1903.98) {
    aliquota_ir = 0;
} else if (salario_liquido_1 <= 2826.65) {
    aliquota_ir = 0.075;
} else if (salario_liquido_1 <= 3751.05) {
    aliquota_ir = 0.15;
} else if (salario_liquido_1 <=4664.68) {
    aliquota_ir = 0.225;
} else {
    aliquota_ir = 0.275;
}

desconto_ir = (salario_liquido_1*aliquota_ir);
salario_final = (salario_liquido_1-desconto_ir);

console.log ('salario bruto:'+salario_bruto); 
console.log ('aliquota inss:'+aliquota_inss); 
console.log ('desconto inss:'+desconto_inss); 
console.log ('salario liquido 1:'+salario_liquido_1); 
console.log ('aliquota ir:'+aliquota_ir); 
console.log ('desconto ir:'+desconto_ir); 
console.log ('SALARIO FINAL:'+ salario_final);

//tem ainda os valores a deduzir do ir
