...
// Armazenamos o token numa variável. Num ambiente real, esse valor viria do Local Storage, ou de uma variável de ambiente
...
// Depois, criamos o body. Utilizamos o `stringify` para que possamos enviar esse body como JSON
...
// Para aquecer, vamos começar com uma requisição do tipo `GET`
    //fetch('https://postman-echo.com/get?param1=teste', { // para fazer GET

    fetch('https://postman-echo.com/post?param1=teste', { // para fazer POST
